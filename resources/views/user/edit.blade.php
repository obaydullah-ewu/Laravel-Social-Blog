                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="city" id="" value="{{$user->city}}" class="form-control" autocomplete="city">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="country" class="col-md-4 col-form-label text-md-right">{{ __('Country') }}</label>
                            <div class="col-md-6">
                                <input type="text" name="country" id="" value="{{$user->country}}" class="form-control" autocomplete="country">
                            </div>
                        </div>
                        <div class="form-group row">
